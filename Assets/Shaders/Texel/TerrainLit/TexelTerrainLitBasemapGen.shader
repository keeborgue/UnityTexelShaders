Shader "Hidden/Universal Render Pipeline/Terrain/TexelLit (Basemap Gen)"
{
    Properties
    {
    ...
    Subshader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                masks[1] = SAMPLE_TEXTURE2D(_Mask1, sampler_Mask1, IN.uvSplat01.zw);
                masks[2] = SAMPLE_TEXTURE2D(_Mask2, sampler_Mask2, IN.uvSplat23.xy);
                masks[3] = SAMPLE_TEXTURE2D(_Mask3, sampler_Mask3, IN.uvSplat23.zw);
